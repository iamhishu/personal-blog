...
// import login from "assets/img/template_main.jpg";
...
export default function Pages(props) {
  ...
  // const getBgImage = () => {
  //   if (window.location.pathname.indexOf("/auth/home") !== -1) {
  //     return login;
  //   }
  //   if (window.location.pathname.indexOf("/auth/about") !== -1) {
  //     return login;
